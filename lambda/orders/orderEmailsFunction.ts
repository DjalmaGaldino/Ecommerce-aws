  ...
  return sesClient.sendEmail({
    ...
    Message: {
      Body: {
        Text: {
          Charset: "UTF-8",
          Data: `Recebemos seu pedido de número ${event.orderId} no valor de ${event.billing.totalPrice}`
        }
      },
      Subject: {
        Charset: "UTF-8",
    ...
    Source: "aprendizados2023@gmail.com",
    ReplyToAddresses: ['aprendizados2023@gmail.com']
  }).promise()
}